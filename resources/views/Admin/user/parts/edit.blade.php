        ...
        @if ($user->role_id == 1)
            <div class="col-12">
                <div class="form-group row">
                    ...
                    <input type="checkbox" class="form-control col-2" id="isBest" name="is_best" value="1" placeholder="******">
